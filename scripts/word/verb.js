...
/**
 * Глагол соверщенного вида
 *
 * @param {String} infinitive
 * @constructor
 */
function PerfectVerb(infinitive) {
    Word.call(this, infinitive);
}
PerfectVerb.prototype = Object.create(Word.prototype);
 ...
 * @returns {Object}
 */
PerfectVerb.prototype.inflect = function () {
    var soften;
    var passive = this.endsWith('ся', 'сь');
    var suffix = passive ? ['ся', 'сь', 'шись'] : ['', '', ''];
    var inflection = {};
